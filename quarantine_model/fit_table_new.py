...
with open('fit_parameters/quarantined_model_all_provinces_after_feb_12.p','rb') as f:
...
for province, pdata in tuplelist:
    ...
    P = k0/(k+k0)
    R0eff = a / (b+k+k0)
    tabledata.append([titlemap[province], Q, R0eff, N, k, I0f, ])
...
with open('fit_parameters/quarantine_parameters_after_Feb_12.tex','w') as f:
    f.write(latex)
